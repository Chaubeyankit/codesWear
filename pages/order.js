...
const Order = () => {
  return (
    <>
      <div className="2xl:container 2xl:mx-auto py-10 px-4 md:px-6 xl:px-48 ">
        <div className="flex flex-col xl:flex-row justify-center items-center space-y-10 xl:space-y-0 xl:space-x-8">
          {/* <div>
            <img className="lg:w-full lg:h-auto h-64 object-cover object-center rounded justify-center" src="/d-confirmation.webp" alt="wardrobe " />
          </div> */}
          <div className="flex justify-center flex-col items-start w-full lg:w-9/12 xl:w-full">
            ...
            <p className="text-base leading-none  mt-4 text-gray-800">OrderId <span className="font-semibold">#8822</span></p>
            <p className="text-base leading-none  mt-4 text-gray-800">Your order has been successfully placed</p>
                ...
                <div className="flex justify-start md:justify-between items-start md:items-center flex-col md:flex-row w-full p-4 md:px-8">
                  <div className="flex flex-col md:flex-shrink-0 justify-start items-start">
                    ...
                    <div className="flex flex-row justify-start space-x-4 md:space-x-6 items-start mt-4">
                      <p className="text-sm leading-none  text-gray-600">Size: <span className="text-gray-800 "> Small</span></p>
                      <p className="text-sm leading-none  text-gray-600">Quantity: <span className="text-gray-800 "> 01</span></p>
                    </div>
                  </div>
            ...
            <div className="flex flex-col justify-start items-start mt-8 xl:mt-10 space-y-10 w-full">
              ...
              <div className="flex flex-col w-full space-y-4">
                ...
                <div className="flex w-full justify-center items-center pt-1 md:pt-4 xl:pt-8 space-y-6 md:space-y-8 flex-col">
                  <button className="dark:bg-pink-500 dark:hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-800 w-full text-base leading-4  text-white font-bold py-3 px-4 border border-pink-700 rounded">Track Your Order</button>
                </div>
              </div>
            </div>
          </div>
